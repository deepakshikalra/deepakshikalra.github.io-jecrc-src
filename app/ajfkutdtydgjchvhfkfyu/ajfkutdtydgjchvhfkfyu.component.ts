...
@Component({
  selector: 'app-ajfkutdtydgjchvhfkfyu',
  templateUrl: './ajfkutdtydgjchvhfkfyu.component.html',
  styleUrls: ['./ajfkutdtydgjchvhfkfyu.component.scss']
})

export class AjfkutdtydgjchvhfkfyuComponent implements OnInit {
